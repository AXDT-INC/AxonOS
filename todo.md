...
- [ ] Image tag `axonos:public-beta` in `docker-compose.yml:32,132,141` and `env.example:14,438,468`: rename for the launch release (deploy-affecting; docs refer to it as "the image tag set in docker-compose.yml").
