...
class FrontendTerminalContractTests(unittest.TestCase):
    ...
    def test_frontend_module_cache_tokens_stay_in_lockstep(self) -> None:
        self.assertIn("axonos-theme.css?v=20.1&t=20260729c", self.page)
        self.assertIn("app/ui.js?v=20260729c", self.page)
        self.assertIn("./webrtc/axonos-webrtc.js?v=20260729c", self.ui)
        self.assertIn("./terminal/axonos-terminal.js?v=20260729c", self.ui)
